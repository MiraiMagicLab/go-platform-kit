...
// MapLegacyPermissionToCapability converts admin.* permission strings to capability notation.
...
// MigrateV3 rewrites admin section permissions to capabilities and bumps schemaVersion to v3.
func MigrateV3(raw json.RawMessage) (json.RawMessage, bool, error) {
