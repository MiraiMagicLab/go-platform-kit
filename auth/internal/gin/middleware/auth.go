...
import (
	"github.com/MiraiMagicLab/go-platform-kit/auth/internal/jwt"
...
func JWTAuth(jwtm *jwt.Manager, users store.UserRepository, denylist store.AccessTokenDenylist) gin.HandlerFunc {
