...
var _ store.RefreshTokenRepository = (*RefreshTokenAdapter)(nil)

// RefreshTokenAdapter wraps *RefreshTokenRepo to implement store.RefreshTokenRepository.
type RefreshTokenAdapter struct {
	repo *RefreshTokenRepo
}

func NewRefreshTokenAdapter(repo *RefreshTokenRepo) *RefreshTokenAdapter {
