...
var _ store.SessionRepository = (*SessionAdapter)(nil)

// SessionAdapter wraps *SessionsRepo to implement store.SessionRepository.
type SessionAdapter struct {
	repo *SessionsRepo
}

func NewSessionAdapter(repo *SessionsRepo) *SessionAdapter {
