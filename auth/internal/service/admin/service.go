...
func NewUserAdminService(users store.UserRepository, refresh store.RefreshTokenRepository) *UserAdminService {
...
func (s *UserAdminService) ListUsers(ctx context.Context, page, pageSize int, filter store.ListUsersFilter) ([]domain.User, int, error) {
