...
type OAuthService struct {
	identities  store.IdentityRepository
...
func NewOAuthService(identities store.IdentityRepository, users store.UserRepository, googleCfg, facebookCfg *oauth2.Config) *OAuthService {
	return &OAuthService{
